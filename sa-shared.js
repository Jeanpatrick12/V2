...
(function () {
  ...
  const DEMO_PROS = [
    ...
    { id:"pr10", name:"Antoine Garcia",             job:"Plombier",           cat:"travaux",    city:"Toulouse",  rating:4.9, reviews:96,  color:"#0d9488", icon:"ti-droplet",      desc:"Dépannage, installation sanitaire et chauffage, disponible 7j/7 pour les urgences.", verified:false,  longDesc:"Plombier-chauffagiste disponible 7j/7 pour les urgences.", services:["Dépannage plomberie urgent","Installation sanitaire complète","Installation et entretien chaudière","Détection de fuite"], zone:"Toulouse et Haute-Garonne", siret:"", phone:"06 00 00 00 08", email:"antoine.garcia@plomberie31.fr" },
    { id:"pr11", name:"Bâti Rénov Atlantique",      job:"Entreprise tous corps d'état", cat:"travaux", city:"Nantes", rating:4.7, reviews:71, color:"#444", icon:"ti-tools", desc:"Rénovation complète clé en main : un seul interlocuteur pour tous les corps de métier.", verified:false, longDesc:"Entreprise tous corps d'état, Bâti Rénov Atlantique coordonne l'ensemble des artisans.", services:["Rénovation complète clé en main","Coordination de chantier","Gros œuvre et second œuvre","Devis global unique"], zone:"Nantes et Loire-Atlantique", siret:"", phone:"06 00 00 00 09", email:"contact@batirenov-atlantique.fr" }
  ];
